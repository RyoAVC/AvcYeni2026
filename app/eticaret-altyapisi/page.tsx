...
export default function CommerceInfrastructurePage() {
  return (
    <main className="catalog-page platform-page">
      ...
      <section className="decision-cta"><span className="kicker">MAĞAZA KAPSAMI</span><h2>Önce satış modelinizi ve operasyonunuzu netleştirelim.</h2><p>Katalog, sipariş, ödeme, teslimat, kanal ve entegrasyon ihtiyaçlarınızı birlikte çıkarıp doğru altyapı kapsamına dönüştürelim.</p><div><Link className="button button-primary" href="/teklif?cozum=eticaret">E-ticaret görüşmesi isteyin</Link><Link className="button button-ghost" href="/cozum-senaryolari/peynir">Peynir mağazası örneğini görün</Link><Link className="button button-ghost" href="/paketler">Paketleri karşılaştırın</Link></div></section>
    </main>
  );
}
