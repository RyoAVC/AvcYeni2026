    ...
    <footer className="site-footer">
      ...
      <div className="footer-main">
        ...
        <nav className="footer-links" aria-label="Alt menü">
          ...
          <div><strong>Rehberler</strong><Link href="/kaynaklar">Kaynaklar</Link><Link href="/yazilimlar">Yazılım Ailesi</Link><Link href="/gizlilik">Gizlilik & KVKK</Link><Link href="/destek">Destek</Link><Link href="/ozel-yazilim">Özel Modül</Link><Link href="/teklif">Demo ve Teklif</Link></div>
          <div><strong>Destek & Kurumsal</strong><Link href="/musteri-merkezi">Müşteri Merkezi</Link><Link href="/olay-bildirim">Olay Bildirimi</Link><Link href="/api-guvenlik">API Güvenliği</Link><Link href="/erisim-denetim">Erişim & Denetim</Link><Link href="/veri-sahipligi">Veri Sahipliği</Link><Link href="/guvenlik">Güvenlik</Link></div>
        </nav>
      </div>
