    ...
    <footer className="site-footer">
      ...
      <div className="footer-main">
        ...
        <nav className="footer-links" aria-label="Alt menü">
          ...
          <div><strong>Destek & Kurumsal</strong><Link href="/musteri-merkezi">Müşteri Merkezi</Link><Link href="/oturum-politika">Oturum Politikası</Link><Link href="/olay-bildirim">Olay Bildirimi</Link><Link href="/erisim-denetim">Erişim & Denetim</Link><Link href="/veri-sahipligi">Veri Sahipliği</Link><Link href="/guvenlik">Güvenlik</Link></div>
        </nav>
      </div>
