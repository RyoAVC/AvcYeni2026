    ...
    <footer className="site-footer">
      ...
      <div className="footer-main">
        ...
        <nav className="footer-links" aria-label="Alt menü">
          ...
          <div><strong>Rehberler</strong><Link href="/kaynaklar">Kaynaklar</Link><Link href="/yazilimlar">Yazılım Ailesi</Link><Link href="/degisiklik-gunlugu">Değişiklik Günlüğü</Link><Link href="/sistem-durumu">Sistem Durumu</Link><Link href="/gizlilik">Gizlilik & KVKK</Link><Link href="/magaza-kvkk">Mağaza KVKK</Link><Link href="/destek">Destek</Link><Link href="/teklif">Demo ve Teklif</Link></div>
