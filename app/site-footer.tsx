    ...
    <footer className="site-footer">
      ...
      <div className="footer-main">
        ...
        <nav className="footer-links" aria-label="Alt menü">
          ...
          <div><strong>Planlama</strong><Link href="/paketler">Paketler</Link><Link href="/fiyatlandirma">Fiyatlandırma</Link><Link href="/proje-sureci">Proje Süreci</Link><Link href="/veri-gecisi">Veri Geçişi</Link><Link href="/alan-adi-hosting">Alan Adı & Hosting</Link><Link href="/hizmetler">Kurulum Hizmetleri</Link></div>
