    ...
    <footer className="site-footer">
      ...
      <div className="footer-main">
        ...
        <nav className="footer-links" aria-label="Alt menü">
          <div><strong>Platform</strong><Link href="/eticaret-altyapisi">E-Ticaret Altyapısı</Link><Link href="/vitrin-tasarim">Vitrin Tasarımı</Link><Link href="/yazilimlar">Yazılım Ailesi</Link><Link href="/ozel-yazilim">Özel Modül</Link><Link href="/entegrasyonlar">Entegrasyonlar</Link><Link href="/yapay-zeka">AI Modülleri</Link></div>
          <div><strong>Satış Modelleri</strong><Link href="/b2b-c2c">B2B & Bayi</Link><Link href="/pazaryeri-kanallari">Pazaryeri Kanalları</Link><Link href="/e-ihracat">E-İhracat</Link><Link href="/mobil-sektorel">Mobil Uygulama</Link><Link href="/seo-gorunurluk">Teknik SEO</Link></div>
          ...
          <div><strong>Rehberler</strong><Link href="/kaynaklar">Kaynaklar</Link><Link href="/fiyatlandirma">Fiyatlandırma</Link><Link href="/cozum-senaryolari">Çözüm Senaryoları</Link><Link href="/referanslar">Referanslar</Link><Link href="/bayi-partner">Bayi & Partner</Link><Link href="/teklif">Demo ve Teklif</Link></div>
