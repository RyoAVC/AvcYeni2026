...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    {
      url: `${baseUrl}/olay-bildirim`,
      lastModified: new Date("2026-08-19"),
      changeFrequency: "monthly",
      priority: 0.6,
    },
    {
      url: `${baseUrl}/api-guvenlik`,
      lastModified: new Date("2026-08-19"),
      changeFrequency: "monthly",
      priority: 0.6,
    },
    {
      url: `${baseUrl}/ortam-ayrimi`,
      lastModified: new Date("2026-08-19"),
      changeFrequency: "monthly",
      priority: 0.6,
    },
    {
      url: `${baseUrl}/eposta-teslim`,
      lastModified: new Date("2026-08-19"),
      changeFrequency: "monthly",
      priority: 0.6,
    },
    {
      url: `${baseUrl}/magaza-kvkk`,
      lastModified: new Date("2026-08-19"),
      changeFrequency: "monthly",
      priority: 0.6,
    },
    {
      url: `${baseUrl}/oturum-politika`,
      lastModified: new Date("2026-08-19"),
      changeFrequency: "monthly",
      priority: 0.6,
    },
    {
      url: `${baseUrl}/kayit-saklama`,
      lastModified: new Date("2026-08-19"),
      changeFrequency: "monthly",
      priority: 0.6,
    },
    {
      url: `${baseUrl}/veri-konumu`,
      lastModified: new Date("2026-08-19"),
      changeFrequency: "monthly",
      priority: 0.6,
    },
