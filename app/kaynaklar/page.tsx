...
const questions = [
  ...
  { question: "Mevcut ürün ve müşteri verilerim taşınabilir mi?", answer: "Taşınabilirlik; kaynak sistemin dışa aktarım imkânına, veri kalitesine ve hedef alan eşlemelerine bağlıdır. Önce örnek veri incelenir, dönüşüm kuralları hazırlanır ve canlı geçişten önce kontrollü prova yapılır. Adımlar veri geçişi sayfasında ayrı yazılır." },
