        ...
        <div className="cp-shell">
          ...
          <div className="cp-main">
            ...
            <div className="cp-panels" aria-live="polite">
              ...
              <DemoPortalPanel as="article" className="cp-card cp-panel-card" id="finans">
              ...
              <DemoPortalPanel as="article" className="cp-card cp-panel-card" id="siparisler">
                <div className="cp-card-head">
                ...
                <p className="cp-card-lead">
                  Yönetimdeki yazılım sipariş satırları burada listelenir. Yeni sipariş veya durum değişikliği bu panelde
                  yapılmaz.
                </p>
              ...
              <DemoPortalPanel as="article" className="cp-card cp-panel-card" id="faturalar">
                <div className="cp-card-head">
                ...
                <p className="cp-card-lead">
                  Tutar notları ve durum bilgisi salt okunurdur. e-Fatura indirme veya ödeme bu ekranda işlenmez.
                </p>
