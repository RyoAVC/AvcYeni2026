  ...
  return (
    <main className="customer-login-page">
      ...
      <section id="portal-girisi">
        <div className="customer-login-copy"><span className="kicker kicker-light">MÜŞTERİ PORTALI</span><h1>Lisans ve faturalarınıza<br /><em>güvenli erişim.</em></h1><p>Aktif Avcı E‑Ticaret müşterileri kayıtlı e-posta ve kendileri için oluşturulan panel parolasıyla giriş yapar. Demo örnek veridir; mağaza üyeliği bu hesaptan ayrıdır.</p><ul><li><span>✓</span>Müşteri hesabı güvenli parola ile doğrulanır</li><li><span>✓</span>Lisans, modül, fatura ve destek görünür</li><li><span>✓</span>Mağaza yönetim hesabı bu portaldan ayrıdır</li></ul><Link className="portal-scope-link" href="/musteri-hesap">Hesap ve parola erişimini inceleyin</Link><Link className="portal-scope-link" href="/musteri-merkezi">Portal kapsamını ve güvenlik sınırını inceleyin</Link></div>
