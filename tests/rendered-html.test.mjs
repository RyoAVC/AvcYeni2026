...
test("renders the finished platform landing page", async () => {
  ...
  assert.match(sitemapXml, /https:\/\/avcieticaret\.com\/odeme-kargo<\/loc>/);
  assert.match(sitemapXml, /https:\/\/avcieticaret\.com\/kampanya-fiyat<\/loc>/);
  assert.match(sitemapXml, /https:\/\/avcieticaret\.com\/stok-operasyon<\/loc>/);
  assert.match(sitemapXml, /https:\/\/avcieticaret\.com\/erisim-denetim<\/loc>/);
  assert.match(sitemapXml, /https:\/\/avcieticaret\.com\/veri-sahipligi<\/loc>/);
  assert.match(sitemapXml, /https:\/\/avcieticaret\.com\/olay-bildirim<\/loc>/);
  assert.match(sitemapXml, /https:\/\/avcieticaret\.com\/api-guvenlik<\/loc>/);
  assert.match(sitemapXml, /https:\/\/avcieticaret\.com\/ortam-ayrimi<\/loc>/);
  assert.match(sitemapXml, /https:\/\/avcieticaret\.com\/eposta-teslim<\/loc>/);
  assert.match(sitemapXml, /https:\/\/avcieticaret\.com\/magaza-kvkk<\/loc>/);
  assert.match(sitemapXml, /https:\/\/avcieticaret\.com\/oturum-politika<\/loc>/);
