...
export const packages = sqliteTable(
  "packages",
  {
    ...
    salesType: text("sales_type").notNull().default("teklif"),
    priceAmountKurus: integer("price_amount_kurus").notNull().default(0),
    priceIncludesVat: integer("price_includes_vat", { mode: "boolean" }).notNull().default(true),
    licenseDurationDays: integer("license_duration_days").notNull().default(0),
